...
import 'package:frontend/features/productivity/goals/widgets/goal_day_outcome_appearance.dart';
...
class GoalMonthLoggedCalendar extends StatelessWidget {
  const GoalMonthLoggedCalendar({
    super.key,
                        ...
                        children: [
                          for (var col = 0; col < _colCount; col++) ...[
                            ...
                            SizedBox(
                              width: cellWidth,
                              height: cellHeight,
                              child: _MonthLoggedDayCell(
                                day: gridDays[row * _colCount + col],
                                monthStart: monthStart,
                                listToday: listToday,
                                outcome: goalDayOutcomeOn(
                                  dayOutcomes,
...
class _GoalCalendarLegend extends StatelessWidget {
  const _GoalCalendarLegend();
  ...
  Widget build(BuildContext context) {
    ...
    return Wrap(
      ...
      children: [
        _LegendItem(
          label: 'Logged',
          appearance: GoalDayOutcomeAppearance.resolve(
            outcome: GoalDayOutcome.logged,
            scheme: scheme,
            isToday: false,
            isFuture: false,
            inMonth: true,
        ...
        _LegendItem(
          label: 'Pending',
          appearance: GoalDayOutcomeAppearance.resolve(
            outcome: GoalDayOutcome.pending,
            scheme: scheme,
            isToday: false,
            isFuture: false,
            inMonth: true,
...
class _LegendItem extends StatelessWidget {
  ...
  final String label;
  final GoalDayOutcomeAppearance appearance;
...
class _MonthLoggedDayCell extends StatelessWidget {
  const _MonthLoggedDayCell({
    required this.day,
  ...
  Widget build(BuildContext context) {
    ...
    final appearance = GoalDayOutcomeAppearance.resolve(
      outcome: outcome,
      scheme: scheme,
      isToday: isToday,
      isFuture: isFuture,
    ...
    final decoration = BoxDecoration(
      ...
      borderRadius: BorderRadius.circular(
        GoalMonthLoggedCalendar._cellRadius,
      ),
